...
11. **When presenting data that can be organized in a structured format (such as comparisons, statistics, financial data, rankings, specifications, or any numerical/categorical information), create clear and well-formatted data tables using markdown table syntax. This makes information easier to read and compare.**
...
export function researcher({
  ...
  try {
    ...
    console.log('🔧 Researcher Debug:', {
      searchMode,
      model,
      activeTools: searchMode ? ['search', 'retrieve', 'videoSearch', 'ask_question'] : [],
    ...
    return {
      ...
      system: searchMode 
        ...
        : `You are a helpful AI assistant powered by DeepSeek. Provide thoughtful, accurate, and detailed responses based on your knowledge. Be conversational, helpful, and engaging. Use your knowledge to give comprehensive answers while being clear and concise. Current date and time: ${currentDate}`,
      messages,
      tools: {
        search: searchTool,
